...
for i in range(epoch):
    ...
    total_loss = 0
    for k in range(0, ((df_scaled.shape[0]-30) // timestamp) * timestamp, timestamp):
        ...
        total_loss += loss
    total_loss /= (df.shape[0]-30) // timestamp
...
plt.legend()
plt.savefig("./output_figure/LSTM_Loss.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/LSTM_predict_signal.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/LSTM_predict_signal_polarity_double_max.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/LSTM_predict_signal_polarity_double_min.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/LSTM_predict_signal_sentiment_double_max.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/LSTM_predict_signal_sentiment_double_min.png")
plt.show()
