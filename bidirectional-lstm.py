...
plt.legend()
plt.savefig("./output_figure/BI-LSTM_Loss.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/BI-LSTM_predict_signal.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/BI-LSTM_predict_signal_polarity_double_max.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/BI-LSTM_predict_signal_polarity_double_min.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/BI-LSTM_predict_signal_sentiment_double_max.png")
plt.show()
...
plt.plot(np.arange(len(signal)), signal, label = 'real signal')
plt.legend()
plt.savefig("./output_figure/BI-LSTM_predict_signal_sentiment_double_min.png")
plt.show()
